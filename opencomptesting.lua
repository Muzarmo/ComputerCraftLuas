...
local cognitojar = component.proxy("f53d07dc-322f-4bc2-a7e8-e3195812ac74")

local victusjar = component.proxy("b48a7b5f-084e-446c-857c-b4cf9d66ec4b")

local ordojar = component.proxy("76b3de14-73f0-49cd-85e5-1ff4111f9c50")

local alienisjar = component.proxy("787a1c51-2249-4869-a6ce-60904ac7274c")
